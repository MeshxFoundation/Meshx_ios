...
#define ChangeLanguageNotificationName @"HXLanguageManagerChangeLanguage"

#define kLocalizedStringComment(key,comment) [kLanguageManager localizedStringForKey:key]
...
#define kLocalizedTableStringComment(key,tableN,comment) [kLanguageManager localizedStringForKey:key tableName:tableN]
