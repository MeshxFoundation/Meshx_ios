...
typedef void (^blueToothDidUpdateValueForCharacteristic)(EasyPeripheral *peripheral,EasyCharacteristic *characteristic,NSError *error);
 ...
 * 设备更新数据时回调
 */
@property(nonatomic, copy) blueToothDidUpdateValueForCharacteristic updateValueBack ;
...
- (void)updateValueForCharacteristicWithBack:(blueToothDidUpdateValueForCharacteristic)back;
