...
@interface XHMessageTableViewController : JMBaseViewController <UITableViewDataSource, UITableViewDelegate, XHMessageTableViewControllerDelegate, XHMessageTableViewControllerDataSource, XHMessageInputViewDelegate, XHMessageTableViewCellDelegate, XHShareMenuViewDelegate,FacePanelDelegate,RecordingDelegate, PlayingDelegate>
 ...
 *  管理第三方gif表情的控件
 */
@property (nonatomic, weak, readonly) FacePanel *emotionManagerView;
