 ...
 *  目标消息Model对象
 */
@property (nonatomic, strong, readonly)  XHMessage * message;

/**
 *  自定义显示文本消息控件，子类化的原因有两个，第一个是屏蔽Menu的显示。第二是传递手势到下一层，因为文本需要双击的手势
 */
@property (nonatomic, weak, readonly) SETextView *displayTextView;
@property (nonatomic,strong) MLLabel *mlLabel;
@property (nonatomic,strong) MLExpression *exp;

/**
 *  用于显示无网络，旋转菊花
 */
@property (nonatomic ,strong) UIActivityIndicatorView *netActivityIndicator;
...
@property (nonatomic, weak, readonly) UIImageView *emotionImageView;
...
*  用于语音正在接收时，指示器
*/
@property (nonatomic ,strong) JQIndicatorView *activityIndicatorView;
