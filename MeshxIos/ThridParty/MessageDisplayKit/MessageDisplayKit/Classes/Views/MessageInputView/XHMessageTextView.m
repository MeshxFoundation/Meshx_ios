...
+ (NSUInteger)numberOfLinesForMessage:(NSString *)text {
    ...
    return ((text.length-1) / [XHMessageTextView maxCharactersPerLine]) + 1;
}
...
- (void)deleteBackward{
    ...
    if ([self.XHDelegate respondsToSelector:@selector(XHMessageTextViewDeleteBackward)]) {
        
        [self.XHDelegate XHMessageTextViewDeleteBackward];
    }
}
