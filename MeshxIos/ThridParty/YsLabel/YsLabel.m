...
- (void)handleTap:(UILongPressGestureRecognizer *)tap{
    ...
    //自定义
    UIMenuItem *copyMenuItem = [[UIMenuItem alloc]initWithTitle:[JMLanguageManager jm_languageCopy] action:@selector(copyAction:)];
...
//    UIMenuItem *selectAllItem = [[UIMenuItem alloc]initWithTitle:@"全选" action:@selector(selectAllAction:)];
    ...
    [menuController setMenuItems:[NSArray arrayWithObjects:copyMenuItem, nil,nil]];
